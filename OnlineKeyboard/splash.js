class Splash {
 ...
 constructor() {
  ...
  this.title = createDiv("P5JS Keyboard in 12 Semitones Standard");
  ...
  this.name = createDiv("Made by Thomas Wang");
  this.name.position(this.splashBorder+20, this.splashBorder+60);
  
  this.info = createDiv("This is just a simple online piano where you can trigger the note either by pressing the mouse or keypad, the keyboard setting for this piano is 'A','W','S','E','D','F','T','G','Y','H,'U','J', and 'K'.<p> I made it for fun and hope you guys will like it.<p> <a href=https://editor.p5js.org/TWTheOfficial/sketches/V7L43UkPx>view code</a>");
